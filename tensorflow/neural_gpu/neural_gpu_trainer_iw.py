...
import neural_gpu_iw_multibatch as neural_gpu
...
tf.app.flags.DEFINE_float("p", 0.1, "p Parameter for Importance Weights.")
tf.app.flags.DEFINE_float("C", 1.0, "C parameter for Importance Weights.")
tf.app.flags.DEFINE_float("iw_batches", 10, "Number of batches before calculating Importance Weights.")
  ...
  with tf.Session() as sess:
    ...
    while True:
      ...
      for _ in xrange(FLAGS.steps_per_checkpoint):
        ...
        loss, res, gnorm, _ = model.step_train(sess,
                                               inp,
                                               target,
                                               batch_size,
                                               noise_param,
